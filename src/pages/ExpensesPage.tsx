    ...
    <div className="space-y-5">
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-ink-400">{monthLabel(selectedMonth)}</p>
        </div>
      ...
      <Card padded={false}>
        <div className="flex items-center justify-between px-5 py-4">
          <h3 className="text-sm font-medium text-ink-700">
            רשימת הוצאות
            {filter && (
              <span className="text-ink-400"> · מסונן לפי "{filter}"</span>
            )}
          </h3>
          {filter && (
  ...
  return (
    <Card className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h3 className="text-sm font-medium text-ink-700">סך הוצאות לפי חודש</h3>
